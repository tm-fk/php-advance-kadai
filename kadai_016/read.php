    ...
    <maini>
      <article class="books">
        ...
        if (isset($_GET['message'])) {
           echo "<p class='sussess'>{$_GET['message']}</p>";
        }
        ?>
        <div class="books-ui">
          <div>
            ...
            <form action="read.php" method="get" class="search-form">
              <inpot type="hidden" name="order" value="<?= $order ?>">
       ...
       <table class="books-table">
        ...
        <tr>
          ...
          foreach ($books as $book) {
            ...
            <td><a href='delete.php?id={$book['id']}'><img src='images/delete.png' alt=P'削除' class='delete-icon'</a></td>
            </tr>
            ";
